...
namespace RCLL_Degital_Clock
{
    public partial class Main : Form
    {
        ...
        {
            MessageBox.Show("RCLL Digital Clock tool, version 1.6, developed by YoussefSalah842, all rights reserved", "About",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
        ...
        {
            this.Hide();
            MainAR ArabicWindow = new MainAR();
            ArabicWindow.Show();
        }
    }
}
